...
##  [/BlazorQueue.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorQueue.Client)
...
## [/BlazorQueue](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorQueue)

The .NET 6 `/BlazorQueue` backend server is required for this App's dynamic functions including the Hello API on the home page
